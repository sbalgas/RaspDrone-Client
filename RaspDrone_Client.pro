...
include(RaspDrone_ClientSource.pri)
include(RaspDrone_ClientHeader.pri)
include(RaspDrone_ClientConfig.pri)
include(RaspDrone_ClientIncludes.pri)
include(RaspDrone_ClientDefines.pri)
...
RaspDrone_Client-Linux-Debug.commands = $$build RaspDrone_Client Linux Debug  -project="\"$$gameProjectFile\"" $$args
RaspDrone_Client-Linux-DebugGame.commands = $$build RaspDrone_Client Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
RaspDrone_Client-Linux-Shipping.commands = $$build RaspDrone_Client Linux Shipping  -project="\"$$gameProjectFile\"" $$args
RaspDrone_Client-Linux-Test.commands = $$build RaspDrone_Client Linux Test  -project="\"$$gameProjectFile\"" $$args
RaspDrone_Client.commands = $$build RaspDrone_Client Linux Development  -project="\"$$gameProjectFile\"" $$args

RaspDrone_ClientEditor-Linux-Debug.commands = $$build RaspDrone_ClientEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
RaspDrone_ClientEditor-Linux-DebugGame.commands = $$build RaspDrone_ClientEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
RaspDrone_ClientEditor-Linux-Shipping.commands = $$build RaspDrone_ClientEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
RaspDrone_ClientEditor-Linux-Test.commands = $$build RaspDrone_ClientEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
RaspDrone_ClientEditor.commands = $$build RaspDrone_ClientEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	RaspDrone_Client-Linux-Debug \
	RaspDrone_Client-Linux-DebugGame \
	RaspDrone_Client-Linux-Shipping \
	RaspDrone_Client-Linux-Test \
	RaspDrone_Client \
	RaspDrone_ClientEditor-Linux-Debug \
	RaspDrone_ClientEditor-Linux-DebugGame \
	RaspDrone_ClientEditor-Linux-Shipping \
	RaspDrone_ClientEditor-Linux-Test \
	RaspDrone_ClientEditor \
