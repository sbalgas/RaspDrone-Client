...
RaspDrone_Client-Linux-Debug:
	 $(PROJECTBUILD) RaspDrone_Client Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

RaspDrone_Client-Linux-DebugGame:
	 $(PROJECTBUILD) RaspDrone_Client Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

RaspDrone_Client-Linux-Shipping:
	 $(PROJECTBUILD) RaspDrone_Client Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

RaspDrone_Client-Linux-Test:
	 $(PROJECTBUILD) RaspDrone_Client Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

RaspDrone_Client:
	 $(PROJECTBUILD) RaspDrone_Client Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

RaspDrone_ClientEditor-Linux-Debug:
	 $(PROJECTBUILD) RaspDrone_ClientEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

RaspDrone_ClientEditor-Linux-DebugGame:
	 $(PROJECTBUILD) RaspDrone_ClientEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

RaspDrone_ClientEditor-Linux-Shipping:
	 $(PROJECTBUILD) RaspDrone_ClientEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

RaspDrone_ClientEditor-Linux-Test:
	 $(PROJECTBUILD) RaspDrone_ClientEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

RaspDrone_ClientEditor:
	 $(PROJECTBUILD) RaspDrone_ClientEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
